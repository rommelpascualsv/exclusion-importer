...
CREATE TABLE `exclusion_lists` (
  ...
  `auto_import`  varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL ,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `exclusion_lists` (`id`, `prefix`, `accr`, `description`, `url`, `verify_email`, `columns`, `employee_title`, `vendor_title`, `import_url`, `auto_import`)
VALUES
  ...
  (6,'il1','IL OIG','Illinois Department of human Services, Office of the Inspector General','http://www.state.il.us/agency/oig/search.asp','','{\"ProvName\":\"Provider Name\",\"LIC\":\"License #\",\"AFFILIATION\":\"Affiliation\",\"ACTION_DT\":\"Action Date\",\"ACTION_TYPE\":\"Action Type\",\"ADDRESS\":\"Address\",\"ADDRESS2\":\"Address 2\",\"CITY\":\"City\",\"STATE\":\"State\",\"ZIP_CODE\":\"Zip\"}','[\"provider\"]','[\"provider\"]',NULL,'N'),
  (7,'ky1','KY CHFS','Kentucky Cabinet for Health and Family Services','http://chfs.ky.gov/dms/','Angela.conway@ky.gov','{\"first_name\":\"First Name\",\"last_name_or_practice\":\"Last Name\",\"npi\":\"NPI #\",\"license\":\"License\",\"terminated\":\"Terminated\",\"state_excluded\":\"State Excluded\"}','[\"first_name\",\"last_name\"]','[\"entity\"]',NULL,'N'),
  (8,'ma1','MA HHS','Massachusetts Health and Human Services','http://www.mass.gov/eohhs/provider/licensing/occupational/nursing/complaint-resolution/disciplinary-actions.html','','{\"last_name\":\"Last Name\",\"first_name\":\"First Name\",\"middle\":\"Middle\",\"license_type\":\"License Type\",\"license_number\":\"License Number\",\"action\":\"Action\",\"effective_date\":\"Effective Date\"}','[\"first_name\",\"last_name\"]','[\"entity\"]',NULL,'N'),
  (9,'sc1','SC HHS','South Carolina Department Health and Human Services','http://www1.scdhhs.gov/openpublic/insidedhhs/bureaus/BureauofComplianceandPerformanceReview.asp#ExcludedProviderList','godleypk@scdhhs.gov','{\"entity\":\"Entity\",\"npi\":\"NPI\",\"city\":\"City\",\"state\":\"State\",\"zip\":\"Zip\",\"provider_type\":\"Provider Type\",\"date_excluded\":\"Date Excluded\"}','[\"provider\"]','[\"provider\"]',NULL,'N'),
  ...
  (40,'ga1','GA DCH','Georgia Department of Community Health','http://dch.georgia.gov/georgia-oig-exclusions-list','','{\"last_name\":\"Last Name\",\"first_name\":\"First Name\",\"business_name\":\"Business Name\",\"general\":\"General\",\"state\":\"State\",\"sanction_date\":\"Sanction Date\"}','[\"first_name\", \"last_name\"]','[\"business_name\"]',NULL,'N'),
  (41,'me1','ME DHHS','Maine Department of Health and Human Services','https://mainecare.maine.gov/mhpviewer.aspx?FID=MEEX','','{\"entity\":\"Entity\",\"last_name\":\"Last Name\",\"first_name\":\"First Name\",\"middle_initial\":\"Middle Initial\",\"prov_type\":\"Provider Type\",\"case_status\":\"Case Status\",\"sanction_start_date\":\"Sanction Start Date\"}','[\"first_name\",\"middle_initial\", \"last_name\"]','[\"entity\"]',NULL,'N'),
  (42,'fdac','FDA CI','FDA Clinical Investigators','https://s3.amazonaws.com/StreamlineVerify-Storage/exclusion-lists/fda-clinical-investigators/FDA-Clinical+Investigators+-+Disqualification+Proceedings_110920150.csv','','{\"name\":\"Name\",\"center\":\"Center\",\"status\":\"Case Status\",\"date_of_status\":\"Date of Status\", \"date_of_nidpoe_issued\":\"Date NIDPOE Issued\",\"date_nooh_issued\":\"Date NOOH Issued\"}','[\"name\"]','[\"name\"]',NULL,'N'),
  (43,'phs','NHH PHS','NHH PHS','https://ori.hhs.gov/phs-admin-action-bulletin-board','','{\"first_name\":\"First Name\",\"last_name\":\"Last Name\",\"middle_name\":\"Middle Name\",\"debarment_until\":\"Debarment Until\"}','[\"first_name\", \"last_name\"]','[\"name\"]',NULL,'N'),
  (44,'usdocdp','UDoC DP','US Department of Commerce, Bureau of Industry and Security, Denied Persons','http://www.bis.doc.gov/index.php/policy-guidance/lists-of-parties-of-concern/denied-persons-list','','{\"name\":\"Business Name\",\"street_address\":\"Address\",\"city\":\"City\",\"country\":\"Country\",\"effective_date\":\"Effective Date\",\"postal_code\":\"Postal Code\",\"expiration_data\":\"Expiration Date\",\"last_update\":\"Last Update\"}','[\"name\"]','[\"name\"]',NULL,'N'),
  (45,'fdadl','FDA DL','FDA Debarment List (Drug Product Applications)','http://www.fda.gov/ICECI/EnforcementActions/FDADebarmentList/default.htm','','{\"name\":\"Name\",\"effective_date\":\"Effective Date\",\"term_of_debarment\":\"Term of Debarment\",\"from_date\":\"From Date\"}','[\"name\"]','[\"name\"]',NULL,'N'),
  (46,'cus_spectrum_debar','CUS SD','Custom Debar List','','','{\"name\":\"Name\",\"title\":\"Title\",\"ssn\":\"SSN\",\"tin\":\"TIN\",\"npi\":\"NPI\",\"date_of_birth\":\"Date of Birth\",\"street_address\":\"Street Address\",\"city\":\"City\",\"state\":\"State\",\"zip\":\"Zip\",\"debar_date\":\"Debar Date\",\"suspend_date\":\"Suspend Data\",\"debar_code\":\"Debar Code\"}','[\"name\"]','[\"name\"]',NULL,'N'),
  (47, 'usdosd', 'US Dos DL', 'US Department of State Debar List', 'http://www.pmddtc.state.gov/compliance/debar_intro.html', '', '{\"full_name\":\"Full Name\",\"aka_name\":\"AKA Names\",\"date_of_birth\":\"DOB\",\"notice\":\"Notice Date\",\"notice_date\":\"Notice Date\"}', '[\"full_name\"]', '[\"full_name\"]', 'https://www.pmddtc.state.gov/compliance/documents/debar.xlsx','N');
...
(`id`, `prefix`, `accr`, `description`, `url`, `verify_email`, `columns`, `employee_title`, `vendor_title`, `import_url`, `auto_import`)
VALUES ('48', 'unsancindividuals', 'UN Sanc Individuals', 'UN Sanctions Individuals List',
        ...
        '["first_name","second_name"]', '["first_name","second_name"]', 'https://www.un.org/sc/suborg/sites/www.un.org.sc.suborg/files/consolidated.xml','N');
...
VALUES ('49', 'unsancentities', 'UN Sanc Entities', 'UN Sanctions Entities List',
        ...
        '["entity_name"]', '["entity_name"]', 'https://www.un.org/sc/suborg/sites/www.un.org.sc.suborg/files/consolidated.xml','N');
