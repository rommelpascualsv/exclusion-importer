...
VALUES
  ...
  (6,'il1','IL OIG','Illinois Department of human Services, Office of the Inspector General','http://www.state.il.us/agency/oig/search.asp','','{\"ProvName\":\"Provider Name\",\"LIC\":\"License #\",\"AFFILIATION\":\"Affiliation\",\"ACTION_DT\":\"Action Date\",\"ACTION_TYPE\":\"Action Type\",\"ADDRESS\":\"Address\",\"ADDRESS2\":\"Address 2\",\"CITY\":\"City\",\"STATE\":\"State\",\"ZIP_CODE\":\"Zip\"}','[\"provider\"]','[\"provider\"]',NULL),
  (7,'ky1','KY CHFS','Kentucky Cabinet for Health and Family Services','http://chfs.ky.gov/dms/','Angela.conway@ky.gov','{\"first_name\":\"First Name\",\"last_name_or_practice\":\"Last Name\",\"npi\":\"NPI #\",\"license\":\"License\",\"terminated\":\"Terminated\",\"state_excluded\":\"State Excluded\"}','[\"first_name\",\"last_name\"]','[\"entity\"]',NULL),
  (8,'ma1','MA HHS','Massachusetts Health and Human Services','http://www.mass.gov/eohhs/provider/licensing/occupational/nursing/complaint-resolution/disciplinary-actions.html','','{\"last_name\":\"Last Name\",\"first_name\":\"First Name\",\"middle\":\"Middle\",\"license_type\":\"License Type\",\"license_number\":\"License Number\",\"action\":\"Action\",\"effective_date\":\"Effective Date\"}','[\"first_name\",\"last_name\"]','[\"entity\"]',NULL),
  (9,'sc1','SC HHS','South Carolina Department Health and Human Services','http://www1.scdhhs.gov/openpublic/insidedhhs/bureaus/BureauofComplianceandPerformanceReview.asp#ExcludedProviderList','godleypk@scdhhs.gov','{\"entity\":\"Entity\",\"npi\":\"NPI\",\"city\":\"City\",\"state\":\"State\",\"zip\":\"Zip\",\"provider_type\":\"Provider Type\",\"date_excluded\":\"Date Excluded\"}','[\"provider\"]','[\"provider\"]',NULL),
  ...
  (28,'os1','OFAC SDN','Specially Designated Nationals','http://www.treasury.gov/resource-center/sanctions/SDN-List/Pages/default.aspx','','{\"firstName\":\"First Name\",\"lastName\":\"Last Name\",\"title\":\"Title\",\"sdnType\":\"SDN Type\",\"remarks\":\"Remarks\"}','[\"firstName\", \"lastName\"]','[\"firstName\", \"lastName\"]',NULL),
...
CREATE TABLE `fdac_records` (
  ...
  `midname` varchar(100) CHARACTER SET utf8 NOT NULL,
  `busname` varchar(100) CHARACTER SET utf8 NOT NULL,
  `general` varchar(100) CHARACTER SET utf8 NOT NULL,
  ...
  `zip` char(10) CHARACTER SET utf8 NOT NULL,
  `excltype` varchar(50) CHARACTER SET utf8 NOT NULL,
  `excldate` date DEFAULT NULL,
  `reindate` date DEFAULT NULL,
  `waiverdate` date DEFAULT NULL,
  `wvrstate` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `hash` binary(16) NOT NULL,
  `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
