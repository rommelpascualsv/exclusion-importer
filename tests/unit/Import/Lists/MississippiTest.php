...
class MississippiTest extends \Codeception\TestCase\Test
{
	...
	public function testHeaderRowsShouldNotBeIncludedInData()
	{
        ...
        $importer->data = [
	        ['','Provider Name','Provider Address','NPI','Prov Type/Specialty','Termination Effective Date','Exclusion Period','Termination Reason','Sanction Type'],
	        ['1','A& B Medical Supplies','444 Gracie Lane Moscow Mills, MO 63362','1427126242','DME','2014/05/15','May 15, 2014 - Indefinite','Failure to disclose all ownership and managing employees.','ME']
	    ];   
	...
	public function testDBAShouldBeRemovedFromEntityNameAndSavedAsAnotherColumn()
	{
	    ...
	    $importer->data = [
	        ['12','Collins and Collins, LLC dba CCI Professional Healthcare Hospice','316 Central Avenue                   Laurel, MS 39441','1033155510','Hospice','2012/10/05','October 5, 2012 - October 5, 2022','Owner or managing agent excluded by OIG','OIG']
	    ];
	...
	public function testFirstMiddleAndLastNamesShouldBeParsedIntoSeparateColumns()
	{
	    ...
	    $importer->data = [
	        ['3','Alexander, Lon Nate F.','1860 Chadwick Drive, STE 205                    Jackson, MS 39204','1073595989','Neurological Surgery','2014/03/12','March 12, 2014 - January 15, 2015','Prohibited from practicing medicine by MS State Board of Medical Licensure.','LB']
	    ];
	...
	public function testFirstMiddleLastAndEntityNamesShouldBeParsedIntoSeparateColumns()
	{
	    ...
	    $importer->data = [
	        ['32','James, Dana Michelle               Central MS Correctional Facility','P O Box 88550                                  Pearl, MS 39208','','Nurse','2005/02/07','February 7, 2005 - February 7, 2010','License Revoked','LB']
	    ];
	...
	public function testOwnerNameShouldBeParsedIntoFirstMiddleAndLastNameColumns()
	{
	    ...
	    $importer->data = [
            ['36','Longwind Products & Services       Lonnie Walker - Owner','205 West Woodrow Wilson               Jackson, MS 39213','1407889934','DME','2012/08/08','August 8, 2012 - Indefinite','Owner, Lonnie Walker, sentenced to 15 months in US Bureau of Prisons','F'],
	        ['36','Longwind Products & Services       Lonnie X. Walker - Owner','205 West Woodrow Wilson               Jackson, MS 39213','1407889934','DME','2012/08/08','August 8, 2012 - Indefinite','Owner, Lonnie Walker, sentenced to 15 months in US Bureau of Prisons','F']
	    ];
	...
	public function testMultipleNPIsShouldBeParsedCorrectly()
	{
	    ...
	    $importer->data = [
	        ['3','Alexander, Lon F.','1860 Chadwick Drive, STE 205                    Jackson, MS 39204','1073595989, 1346485794','Neurological Surgery','2014/03/12','March 12, 2014 - January 15, 2015','Prohibited from practicing medicine by MS State Board of Medical Licensure.','LB']
	    ];
	...
	public function testUnknownSanctionTypeShouldBeParsedAsIs()
	{
	    ...
	    $importer->data = [
	        ['3','Alexander, Lon F.','1860 Chadwick Drive, STE 205                    Jackson, MS 39204','1073595989, 1346485794','Neurological Surgery','2014/03/12','March 12, 2014 - January 15, 2015','Prohibited from practicing medicine by MS State Board of Medical Licensure.','XX']
	    ];
