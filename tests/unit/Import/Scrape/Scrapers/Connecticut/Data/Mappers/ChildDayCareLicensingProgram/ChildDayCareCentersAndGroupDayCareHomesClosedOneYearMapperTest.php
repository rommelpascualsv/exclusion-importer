...
class ChildDayCareCentersAndGroupDayCareHomesClosedOneYearMapperTest extends \Codeception\TestCase\Test
{
    /**
     * @var \UnitTester
     */
    ...
    {
        $this->mapper = new ChildDayCareCentersAndGroupDayCareHomesClosedOneYearMapper();
    }
