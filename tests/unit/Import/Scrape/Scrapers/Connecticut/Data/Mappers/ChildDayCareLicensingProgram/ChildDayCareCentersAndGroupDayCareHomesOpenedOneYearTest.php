...
class ChildDayCareCentersAndGroupDayCareHomesOpenedOneYearTest extends \Codeception\TestCase\Test
{
    /**
     * @var \UnitTester
     */
    ...
    {
        $this->mapper = new ChildDayCareCentersAndGroupDayCareHomesOpenedOneYear();
    }
